 ...
 * @author julian
 */
public class crear_Farmacia extends javax.swing.JFrame {

    /**
     * Creates new form crear_Farmacia
     */
    public crear_Farmacia() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(crear_Farmacia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new crear_Farmacia().setVisible(true);
            }
        });
    }
