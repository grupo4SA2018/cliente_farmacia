 ...
 * @author julian
 */
public class crear_medicamento extends javax.swing.JFrame {

    /**
     * Creates new form crear_medicamento
     */
    public crear_medicamento() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(crear_medicamento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new crear_medicamento().setVisible(true);
            }
        });
    }
